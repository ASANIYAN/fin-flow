  ...
  return (
    <section className="w-full flex justify-between items-center">
          ...
          <div className="flex items-center justify-between border border-[--color-brand-primary]/40 rounded-lg bg-blue-50 p-2 w-fit h-8.5">
            ...
            <div className="flex flex-col">
              <button
                ...
                className="border-none disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <Icon
                  width={14}
                  height={10}
      ...
      <div className="flex items-center gap-4 h-10">
        <button
          className={`h-full w-28.5 text-xs rounded bg-gray-400 text-white font-medium flex justify-center items-center gap-1 ${
        ...
        <button
          className={`h-full w-21.5 rounded font-medium text-xs flex items-center justify-center gap-1 text-white ${
        ...
        >
          Next{" "}
          <Icon color="#EEEAEA" icon="material-symbols-light:double-arrow" />{" "}
        </button>
      </div>
    </section>
  );
